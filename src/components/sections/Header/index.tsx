...
function MobileMenu(props) {
    ...
    return (
        <div className="ml-auto lg:hidden">
            <button aria-label="Open Menu" title="Open Menu" className="p-2 -mr-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded" onClick={openMobileMenu}>
            ...
            <div className={classNames(colors, 'fixed', 'inset-0', styles?.self?.padding ?? 'p-4', 'overflow-y-auto', 'z-10', isMenuOpen ? 'block' : 'hidden')}>
                <div className="flex flex-col min-h-full">
                    <div className="flex items-center justify-between mb-10">
                        ...
                        <button aria-label="Close Menu" title="Close Menu" className="p-2 -mr-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded" onClick={closeMobileMenu}>
